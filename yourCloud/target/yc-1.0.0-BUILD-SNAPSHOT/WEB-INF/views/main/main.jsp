                ...
                <div class="col-lg-4 col-sm-12 col-12 box-1">
                    <div class="row box" data-aos="fade-left" data-aos-delay="300">
                        ...
                        <div class="col-lg-10 col-sm-12">
                            ...
                            <p><a href="services.html"><img src="/WEB-INF/images/plus.png" alt="plus"></a></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12 col-12 box-1"  data-aos="fade-right" data-aos-delay="300">
                    <figure class="figure">
                        <a href="blog.html"><img src="/WEB-INF/images/phan.PNG" class="figure-img img-fluid" alt="blog"></a>
                ...
                <div class="col-lg-8 col-sm-12 col-12" data-aos="fade-left" data-aos-delay="300">
                    <div class="row" >
                        <div class="col-sm-6 col-12 box-2">
                            <figure class="figure">
                                <a href="blog.html"><img src="/WEB-INF/images/hwnag.PNG" class="figure-img img-fluid" alt="blog"></a>
                            </figure>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-12 box-4">
                            <figure class="figure">
                                <a href="blog.html"><img src="/WEB-INF/images/holding.PNG" class="figure-img img-fluid" alt="blog"></a>
                            </figure>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-12 box-6">
                            <figure class="figure">
                                <a href="blog.html"><img src="/WEB-INF/images/chi.PNG" class="figure-img img-fluid" alt="blog"></a>
                            </figure>
                        </div>
    ...
    <section class="section-4">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12 col-12 box-1"  data-aos="fade-right" data-aos-delay="300">
                    <figure class="figure">
                        <a href="blog.html"><img src="/WEB-INF/images/glasses.PNG" class="figure-img img-fluid" alt="blog"></a>
                        <figcaption class="figure-caption">
